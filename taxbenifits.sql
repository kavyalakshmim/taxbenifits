create table Address_Type (Address_Type_ID Integer NOT NULL PRIMARY KEY, DESCRIPTION VARCHAR2(100) NOT NULL);
CREATE TABLE USER_TYPE(USER_TYPE_ID INTEGER NOT NULL PRIMARY KEY, Description VARCHAR2(100) NOT NULL);
...
CREATE TABLE USER1(USER_ID INTEGER NOT NULL PRIMARY KEY, FIRST_NAME VARCHAR2(100) NOT NULL,MIDDLE_NAME VARCHAR2(100),LAST_NAME VARCHAR2(100) NOT NULL,
...
BANK_NAME VARCHAR2(100) NOT NULL,BRANCH_NAME VARCHAR2(100) NOT NULL,ACCOUNT_NUMBER VARCHAR2(100) NOT NULL,BANK_ADDRESS_ID INTEGER NOT NULL,
...
YEAR INTEGER NOT NULL,MARITAL_STATUS VARCHAR2(10) NOT NULL,NUMBER_OF_DEPENDENTS INTEGER NOT NULL,DEPENDENT VARCHAR(10) NOT NULL,
...
STATE_NAME VARCHAR2(100) NOT NULL,STATE_CODE VARCHAR2(100) NOT NULL,ANNUAL_INCOME INTEGER NOT NULL,STATE_TAX INTEGER NOT NULL,
